...
namespace Inventory.Domain.Migrations
{
    ...
    [Migration("20230215163614_SeedCommonAttributesNDataTypeForStringSetToNVarchar")]
    partial class SeedCommonAttributesNDataTypeForStringSetToNVarchar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.CommonAttribute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 2, 15, 16, 36, 14, 154, DateTimeKind.Utc).AddTicks(4064)
                        },
                        new
                        {
                            Id = 2,
                            AttributeName = "Kg",
                            AttributeType = "Quantity",
                            CreateDate = new DateTime(2023, 2, 15, 16, 36, 14, 154, DateTimeKind.Utc).AddTicks(4068)
                        },
                        new
                        {
                            Id = 3,
                            AttributeName = "Meter",
                            AttributeType = "Quantity",
                            CreateDate = new DateTime(2023, 2, 15, 16, 36, 14, 154, DateTimeKind.Utc).AddTicks(4070)
                        });
                });
